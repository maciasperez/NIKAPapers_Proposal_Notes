...
\begin{figure*}[h]
   \centering
%    \includegraphics[width=0.9\linewidth]{Fig4_spectra.png}
    \includegraphics[trim=1cm 12cm 4cm 3cm, clip=true,width=0.33\linewidth]{A1_fwhm_valid.pdf}
   \includegraphics[trim=1cm 12cm 4cm 3cm, clip=true,width=0.33\linewidth]{A3_fwhm_valid.pdf}
   \includegraphics[trim=1cm 12cm 4cm 3cm, clip=true,width=0.33\linewidth]{A2_fwhm_valid.pdf}       
...
\begin{figure*}[h]
   \centering
    \includegraphics[width=0.33\linewidth]{A1_noise_spec.pdf}     
       \includegraphics[width=0.33\linewidth]{A2_noise_spec.pdf}     
   \includegraphics[width=0.33\linewidth]{A3_noise_spec.pdf}     
