...
expected because the telescope is a $30\,\rm{m}$ dish and therefore has a \todo{XXXX
  near field of XXXXX m}. 
...
\caption[Noise RMS and power spectra]{From top to bottom and from left to right,
  ...
  different readout electronic boxes. Whithin each electronic box the pixels are
