...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       {The New IRAM KID Array Two, NIKA2, is a dual-band millimetric
         camera of thousands of Kinetic Inductance Detectors (KID)
         installed at the IRAM 30-meter
         telescope at Pico Veleta ($2850\,\rm{m}$) in Spain.
         ...
         Open to the community since October 2017, NIKA2 
       ...
       {We use a vast data set acquired between January 2017 and
         ...
         of observing elevation and atmospheric conditions encoutered at the
       ...
       {We report a well covered instantaneous field-of-view of 6.5'
         ...
         The statistical relative calibration uncertainties are of about $3\%$
