...
dedicated to the tuning of the KID tones to their resonance frequency, and
the timeline of KIDs whose noise level exceed $3\sigma$ of the average
...
each KID with respect with the reference KID using a dedicated
...
different origins: the atmospheric component, which is common to all
KIDs, and the electronic noise, which is common to the KIDs connected
...
A illustrated on the first panel of Fig.~\ref{fig:nika_toi}, the
...
pixel as defined using a nearest grid point scheme. The noise variance of a
