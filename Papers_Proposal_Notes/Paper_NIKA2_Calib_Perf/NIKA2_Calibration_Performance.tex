...
\begin{document} 
   ...
   \title{NIKA2 Calibration and Performance at the IRAM 30-meter Telescope}
...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       {%The New IRAM KID Array Two,
         ...
         installed at the IRAM 30-meter
       ...
       {We use a vast data set acquired between January 2017 and
         ...
         IRAM 30-m telescope. This allows us for testing the
       ...
       {We report a well covered instantaneous FOV of 6.5'
         ...
         by a full width at half maximum (FWHM) of $17.6'' \pm 0.1''$
         ...
         and $6\%$ for these two frequency bands. This validates
         the accuracy of the method that we have deployed to correct for the
         atmosphere attenuation. The noise equivalent
         ...
         $1400 \pm {\color{magenta}XX}$ and
         $100 \pm {\color{magenta}XX} \, \rm{arcmin}^2\, \rm{mJy}^{-2}\,\rm{h}^{-1}$
         at $150$ and $260\,\rm{GHz}$.}
       % conclusions heading (optional), leave it empty if necessary 
       {With this unique capabilities of fast dual-band mapping at
         sub-arminute resolution, NIKA2 is providing unprecedented view
...
\begin{table*}[!thbp]
  ...
  \begin{tabular}{rrrrrl}
    ...
    M$_{\rm{s}}$\tablefootmark{i}\hspace{3mm} [arcmin$^2$/h/mJy$^2$] & 45  & 70  & 111  &  1388 &  \\
    \hline
  \end{tabular}
  \tablefoot{ \\
    \tablefoottext{a}{Number of usable detectors, which were selected in at least two FOV reconstructions}
...
\item %\emph{FOV reconstruction}:
  All the designed KIDs detect the
...
\item %\emph{Beam Properties:}
  ...
  beyond $180''$, the beam efficiency estimates must be corrected by
  about 0.65 at $1\,\rm{mm}$ and about $0.8$ at
...
%trivial.
  ...
  mm arrays (subjected to the improvement of the dichroic) and 3)
