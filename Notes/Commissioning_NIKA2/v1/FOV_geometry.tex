...
5~FWHM at 65 arcsec/s,} and we project one map per KID in Nasmyth
...
\caption[Simulated FOV grid]{NIKA2 grid diagram simulated using ZEMAX. Crosses indicate
  the real coordinates on the Nasmyth image plan. \todo{question a
    Samuel: pourquoi les dimensions indiquees sont environs 4.5 arcmin
    de cote (et pas 6.5)?}  \todo{Marco: This Grid Distortion has been generated with M2 in the nominal position.
Does it change along the explored M2 movements?}}
...
optical simulation. %{\bf [TBA, as discussed further below]}.
