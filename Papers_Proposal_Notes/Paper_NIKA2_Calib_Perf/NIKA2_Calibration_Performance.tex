...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       ...
       {We use a vast data set acquired between January 2017 and
         ...
         of observing elevation and atmospheric conditions encountered at the
         IRAM 30-m telescope. This allows us for testing the
         performance parameter stability against time evolution and
         ...
         thoroughtly described, including the reconstruction of the field of view, the
         measurement of the beam pattern, the atmospheric opacity
         derivation, the flux density absolute calibration, the flat
       ...
       {We report a well covered instantaneous field-of-view of 6.5'
         in diameter, {\color{magenta}filled with an average fraction of $84\%$
         ($90\%$) of detectors usable for science analysis at
         $150\,\rm{GHz}$ ($260\,\rm{GHz}$)}. The beam pattern is characterized
         ...
         excellent mapping speeds of about
         $1400$ and
         $100\, \rm{arcmin}^2\, \rm{mJy}^{-2}\,\rm{h}^{-1}$
         at $150$ and $260\,\rm{GHz}$.}
       % conclusions heading (optional), leave it empty if necessary 
       {Owing to this unique capabilities in fast dual-band mapping at
...
\begin{table*}[!thbp]
  ...
  \begin{tabular}{|r|c|c|c|c|l|}
    ...
    \hline
    $\alpha$ noise integration in time\tablefootmark{f}\hspace{3mm}  & 0.5  & 0.5  &  0.5 & 0.5 & Sect.~\ref{se:nefd_results} \\
    \hline
    NEFD\small{(0mm, 90deg)}\tablefootmark{g}\hspace{3mm} [$\rm{mJy} \cdot \rm{s}^{1/2}/\rm{beam}$]  & $47 \pm 4$ & $38 \pm 3$  & $30 \pm 3$  & $9 \pm 1$ & Sect.~\ref{se:nefd_results}\\
...
\item \emph{Sensitivity:} The noise well integrates as the square root of the integration time
  ...
  discussed in Sect.~\ref{se:nefd_results}. The NEFD estimates reported in
  ...
  conditions, as addressed in Sect.~\ref{se:nefd_results}. However,
