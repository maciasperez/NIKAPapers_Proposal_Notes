...
%absolute polarization angle reconstruction.
  ...
  value of $ -88.1^{\circ} \pm 0.3$ in Galactic coordinates.  We also present the first estimation of the Crab nebula Spectral Energy Distribution polarized flux. 
  
  These measures underline the importance of a deep study of the polarization properties of the Crab nebula to be considered as absolute calibrator for both high resolution camera of ground based observatories and next generation of CMB experiments which aim at measuring the polarization of the sky.}
...
Today the Crab nebula (or Tau A) is perhaps the most observed object in the sky beyond our own solar system and often used as calibrator by new instruments.
It is a plerion-type supernova remnant emitting a highly
polarized signal \citep{1978A&A....70..419W,1991ApJ...368..463M}. Moving from the inside out, the Crab consists of the pulsar, the 
synchrotron nebula, a bright expanding shell of thermal gas, and a larger very faint freely expanding supernova remnant \citep{2008ARA&A..46..127H}.
