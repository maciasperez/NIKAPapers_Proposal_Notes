...
ACTpol~\citep{Swetz2011_ACT, ACTpol2017} ou
...
\begin{figure}
  \centering
  \includegraphics[width=0.72\textwidth]{Figures/NIKA2-SZ/Figure_LPSZ_dust_map_FR.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.54\textwidth, clip=true, trim=0cm -0.7cm 0cm 0cm]{Figures/NIKA2-SZ/LPSZ_M_z_grid.pdf}
...
L'effet kSZ est dû au mouvement d'ensemble du milieu intra-amas, il
