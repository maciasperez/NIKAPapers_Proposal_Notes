...
high-sensitivity detectors {\color{magenta} (ref)}. %, challenging the
%motivation for spatial experiments.
...
formation {\color{magenta}(see Andre2014 for a review)}. Ultimately, these
...
observable and the cluster mass, {\color{magenta} and the mean
  pressure profile ?} and on the assessment of both the redshift
...
$90\,\rm{GHz}$~\citep{Dicker2014_MUSTANG2}{\color{magenta}recent ref?}. Therefore, NIKA2 is unique
...
(see \emph{e.g.},~\citet{Adam2017_kSZ} {\color{magenta} tous les
  papiers NIKA ?}). {\color{magenta} Rephrase: NIKA2 surpasses the
...
A thorough description of the NIKA2 instrument is found in \citet{Adam2017},
