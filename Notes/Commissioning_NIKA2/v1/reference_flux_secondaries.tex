...
NIKA2 photometric capabilities after the calibration, as discussed in
Sect.~\ref{se:calibration}, are assessed in this section using
...
\subsection{Reference flux densities of the secondary calibrators {\color{blue} Jean-François}}
