...
non-parametric X-ray products, especially electron density, have \citep[e.g][]{basu2010,planck2013a,ruppin2017}
...
filtering procedure. We find good agreement with the previous results, with
...
within $\sim10$\% agreement of the values reported in \citet{romero2017}.
...
procedure is described in Section~\ref{sec:fitting}, and we review the validity checks performed in
...
large radii (Appendix~\ref{sec:finite_mass}). Similarly, $P_0$ and $C_{500}$ are larger than generally found.
...
$0.05 R_{500} < r < 2 R_{500}$, continuously recovering spatial scales in this range,
...
For a non-rotating, spherical object under hydrostatic equilibrium (HSE), we have:
\begin{equation}
