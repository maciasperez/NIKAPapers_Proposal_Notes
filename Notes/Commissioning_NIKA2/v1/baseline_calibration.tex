...
\begin{figure}[ht!]
  \begin{center}
    % corrected skydip
    \includegraphics[clip=true, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_narrow_1mm.pdf}\hspace{0.2cm}
    \includegraphics[clip=true, width=0.3337\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_narrow_a2.pdf}
    \vspace{0.3cm}
    % taumeter
    \includegraphics[clip=true, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_tau225_narrow_1mm.pdf}\hspace{0.2cm}
    \includegraphics[clip=true, width=0.3337\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_tau225_narrow_a2.pdf}
    \vspace{0.3cm}
    % skydip
    \includegraphics[clip=true, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_skydip_narrow_1mm.pdf}\hspace{0.2cm}
    \includegraphics[clip=true, width=0.3337\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_skydip_narrow_a2.pdf}
    \vspace{0.3cm}
    % corr. sky. photocorr demo
    \includegraphics[clip=true, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_photocorr_demo_narrow_1mm.pdf}\hspace{0.2cm}
    \includegraphics[clip=true, width=0.3337\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_photocorr_demo_narrow_a2.pdf}
    \vspace{0.3cm}
    % corr. sky. photocorr pointing
    \includegraphics[clip=true, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_photocorr_pointing_narrow_1mm.pdf}\hspace{0.2cm}
    \includegraphics[clip=true, width=0.3337\textwidth]{Figures/atrier/plot_flux_density_ratio_fwhm_uranus_corrected_skydip_photocorr_pointing_narrow_a2.pdf}
...
\begin{figure}[ht!]
  \begin{center}
    \includegraphics[clip=true, trim={0, -0.3cm, -0.3cm, 0}, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_obstau_uranus_corrected_skydip_narrow_a1.pdf}
    \includegraphics[clip=true, trim={0, -0.3cm, -0.3cm, 0}, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_obstau_uranus_corrected_skydip_narrow_a3.pdf}
    \includegraphics[clip=true, trim={0, -0.3cm, -0.3cm, 0}, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_obstau_uranus_corrected_skydip_narrow_1mm.pdf}
    \includegraphics[clip=true, trim={0, -0.3cm, -0.3cm, 0}, width=0.35\textwidth]{Figures/atrier/plot_flux_density_ratio_obstau_uranus_corrected_skydip_narrow_a2.pdf}
