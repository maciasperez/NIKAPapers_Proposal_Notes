...
\begin{figure}[hhh]
\begin{center}
\includegraphics[clip, angle=0, scale =0.42]{Figures/hls_NEFD_vs_TauElev_all_mod.pdf}
\includegraphics[clip, angle=0, scale =0.42]{Figures/g2_NEFD_vs_TauElev_all_mod.pdf}
\caption[NEFD per scan]{1\,$\sigma$ sensitivity on the central flux for each
  ...
  and gives the zenith NEFD when extrapolated to $\tau/\sin\delta = 0$.}
