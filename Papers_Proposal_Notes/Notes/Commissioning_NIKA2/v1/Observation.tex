...
\new{during the focus procedure} and this would alter the flux
...
in the previous paragraph. \new{This focus offset is derived using ZEMAX
...
position. \new{This confirms the experience of the IRAM staff with EMIR and
...
\new{Even though EMIR only has a single pixel on the sky, the pointing procedure
...
elevation. \todo{Marco's question: est-ce que les offsets trouvés sont les memes qu'EMIR ? Are the best parameters "only telescope" or "telescope+instrument at focal plane" dependent?}
