...
in Jy/sr. To that aim, we need to take into account the full beam
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{lrrrr}
    ...
    BE$_{0}$   [\% ]             & $60 \pm 6$ &  $61 \pm 6$ & $61 \pm 6$ & $72 \pm 4$ \\
        \noalign{\smallskip}
    \hline
  \end{tabular}
\end{table}
...
Sect.~\ref{se:beam_efficiency}. Propagating the uncertainty on the
