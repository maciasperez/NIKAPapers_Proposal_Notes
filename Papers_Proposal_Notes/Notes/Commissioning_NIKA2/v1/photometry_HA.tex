...
\item $A\Omega (\nu) $: the KID \emph{etendue}, {\it i. e.} the product of
  ...
  the optical system from the front. The entrance pupil is made such
  that the edges of the primary mirror (M1)
  are vignetted in order to avoid strong diffraction effects due to
