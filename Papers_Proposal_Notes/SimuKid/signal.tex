...
fitted circle divided by the radius of this circle.\todo{improve this caption}}
...
as defined on Fig.~\ref{fig:circle_def} \todo{(Add a figure defining the center
  of the circle and $C$, $\alpha$...)}. We thus fit the radius $r$ and the
...
%% \begin{equation}
%% \tan\frac{\delta\varphi}{2} \simeq \frac{\delta\varphi}{2} +
%% \frac{(\delta\varphi)^3}{15}
%% \end{equation}
...
of a point source with a flux that we vary between \todo{XX} and
\todo{XX}~Jy. We assume that our instrument has a 11\,arcsec FWHM Gaussian beam
