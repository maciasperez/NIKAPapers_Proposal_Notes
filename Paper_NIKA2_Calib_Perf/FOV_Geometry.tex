...
obtained using a 2D polynome of degree one, which corresponds to a linear
...
%pointing nor the focus settings.
...
coordinates was designed as $76.2^{\rm{o}}$, ess than two degrees
...
increase with the position of the KID in the feedline, some KIDs are
...
%input of the data reduction pipeline.}
