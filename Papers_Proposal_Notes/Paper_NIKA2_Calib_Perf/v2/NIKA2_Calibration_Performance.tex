...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       ...
       {We report an instantaneous field of view (FOV) of 6.5'
         ...
         for atmospheric attenuation. {\rev For diffuse emission, the
           rms calibration uncertainties must further include the
           uncertainties on the total beam solid angle, which are of
           about $6\%$ and $10\%$ at $150\,\rm{GHz}$ and $260\,\rm{GHz}$,
           respectively}. {\lp The absolute
...
\begin{tabular}{rrrcl}
  ...
  \noalign{\smallskip}
    ...
    Main beam efficiency\tablefootmark{d}\hspace{3mm} [$\%$] & {\rev  $48 \pm 4$}   &  {\rev $63 \pm 3$}  &  & Sect.~\ref{se:beam_efficiency}\\
    ...
    Reference beam efficiency\tablefootmark{f}\hspace{3mm}  [\% ] & {\rev $61 \pm 6$} & {\rev $72 \pm 4$} &  & Sect.~\ref{se:extended_source_calib}\\
    \hline
    \noalign{\smallskip}
...
\item %\emph{Calibration uncertainties:}
  ...
  ground-based millimeter-wave instrument. {\rev The rms calibration
