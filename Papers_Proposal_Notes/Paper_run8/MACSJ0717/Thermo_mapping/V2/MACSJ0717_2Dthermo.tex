...
%\begin{figure*}[h]
%\centering
%\includegraphics[width=0.33\textwidth]{Figure/Thermo_leff5.pdf}
%\includegraphics[width=0.33\textwidth]{Figure/Thermo_leff8.pdf}
%\includegraphics[width=0.33\textwidth]{Figure/Thermo_leff9.pdf}
%\caption{\footnotesize{Electron depth maps, $\ell_{\rm eff}$, in case of models M2 (left), M3a (middle) and M3b (right). In case of model M1, the map is constant at $\ell_{\rm eff} = 1400$ kpc.}}
%\label{fig:leff}
%\end{figure*}
