...
combines high resolution with a high mapping speed and a large
...
has been demonstrated using simulations~\citep{Ruppin2019}.
...
We also assess the performance in intensity using a large
amount of data acquired between January 2017 and February 2018.
The performance assessment of the polarization capabilities will be
addressed in a forthcoming paper.
To achieve a reliable and high-accuracy estimation
of the camera performance we perform extensive testing of the
stability against both the analysis methodological
...
calibration procedure and for each performance parameters, we compare the results
obtained using the \baseline\ method to alternative approaches to
ensure the robustness against systematic effects.}
Second, we check the stability of the result with a large number of
