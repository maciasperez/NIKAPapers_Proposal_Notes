...
which impact only one sample due to the KID fast time constant~\citep{Catalano2014}, periods
...
atmospheric attenuation $\rm{exp}[{-\tau/\sin\elev_t}]$ is corrected
...
elevation $\elev_t$, as given using the pointing reconstruction.\\     
