...
the observing conditions, we have focused our analysis on data from N2R9 and
N2R12. The final results of this commissioning are given in the last section
essentially via a summary table~\ref{tab:nika2summary} with links to the
relevant sections for detailed demonstration of the results. In order to be
self-consistent, the document is also meant to be read in chronological
...
in the following sections. We start with atmospheric opacity in
