...
$0.65 \times$ FWHM and $80''$, so that \sam{the largest error beam and
  side lobes contributions}
...
\begin{center}
  ...
  \caption[Main Beam FWHM distributions]{Distribution of the FWHM
    ...
    N2R14 campaigns (see text). \new{The red curves show a Gaussian fit of
    the distribution; the corresponding best-fitting position of the maximum and
    $\sigma$ are given in the legend in units of arcsec}}
\label{fig:fwhm_map}
\end{center}
\end{figure}
...
\caption[Main beam FWHM distribution across the array]{Main beam FWHM
  ...
  the histogram data\new{, from which the average (Avg) and rms (Sig)
  given in the legend in arcsec are derived.}}
