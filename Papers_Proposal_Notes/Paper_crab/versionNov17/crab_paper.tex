...
%absolute polarization angle reconstruction.
  ...
  value of $-87.9^{\circ} \pm 0.3$ in Galactic coordinates.  We also present the first estimation of the Crab nebula Spectral Energy Distribution polarized flux in a wide frequency range: 30-353 GHz. Assuming a single power law synchrotron emission model we find that the polarization spectral index $\beta_{pol}$=-0.35 $\pm$ 0.03, while the intensity spectral index is $\beta$=-0.324 $\pm$ 0.002.}
