...
agreement. The assessment of the photometry is a key point that would deserve an illustration. (but keep the tables as well}\\
...
\begin{figure}[p]
\begin{center}
  \includegraphics[clip, angle=-90, scale=0.7]{Figures/Ratio_vs_elev_op_sec_r9_r10.pdf}
