...
region and indeed NIKA data alone favors a rapid transition. This rapid transition is nominally
quicker with the addition of MUSTANG data due to the drop in recovered pressure at a radius,
$9$\asecs $< r < 23$\asec.
...
to include analysis of slices within an ellipse, which will prove useful for investigating shocks. While our estimation of outer
pressure bins may be influenced by the mean level in a map, or a poorly constrained transfer function, we see that the inner bins
remain largely unaffected.

%Finally, this approach also allows for some estimation of
