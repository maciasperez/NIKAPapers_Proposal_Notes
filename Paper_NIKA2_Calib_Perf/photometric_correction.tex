...
Sect.~\ref{se:beam_variation}. \nico{We have investigated ways to compensate for
  these variations (not related to the NIKA2 instrument) and extend the possible
  range of observing conditions. This section presents one of them, that relies
  on the monitoring of the effective FWHM during an observation. It also offers
  and interesting cross-check of the baseline calibration.}
