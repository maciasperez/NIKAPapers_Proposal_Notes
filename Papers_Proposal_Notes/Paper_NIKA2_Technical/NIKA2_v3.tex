...
In the last decades instrumental progress, and in particular the development of large arrays of almost background limited detectors, has lead to a golden era of millimeter and sub-millimeter continuum astronomy, and in particular cosmology. High resolution ground-based continuum cameras and the Herschel satellite has opened a new window for the study of Galactic and extra-galactic sources mainly via their thermal dust emission. 
On the one hand, Cosmic Microwave Background observations, i.e. the Planck satellite, the balloons-borne and the ground-based instruments, permitted high sensitivity intensity and polarisation measurements driving cosmology to an era of precision. \\
...
However, new scientific challenges are pushing current technology to its limit making necessary new instrumental developments. 


In this framework, submillimeter and millimeter extra-galactic studies are mainly limited by the mapping speed of high resolution instruments and by an adequate spectral coverage. This is the case for example for the study of nearby galaxies which aims at separating the emission from different physical components like thermal dust, free-free and synchrotron. This allows to measure precisely the star formation rate in different environments and regions. Similarly, distant universe studies via deep surveys will benefit of the NIKA2 large mapping speed to cover large sky regions at confusion limit and so to detect dust-obscured optically-faint galaxies during their major episodes of formation in the early universe. Furthermore, multi-wavelengths instruments like NIKA2 permit the reconstruction of the SED of the galaxies giving a complete view of star formation processes. The required large mapping speeds can only be obtained by increasing the number of detectors in the focal plane up to few thousands of them. \\
...
\begin{figure*}[h]
   ...
   \includegraphics[trim=1cm 5cm 2cm 2cm, clip=true,width=0.33\linewidth]{A3_noise_spec.pdf}     
    \caption{From left to right power spectra of the NIKA2 TOI before (black) and after (blue) decorrelation}
         \label{fig:noisespec}
\end{figure*}
...
\begin{figure*}[h]
   ...
   \includegraphics[width=.45\linewidth]{MWC349_1mm_map_snrcont.pdf}
    ...
    \includegraphics[width=.45\linewidth]{Pluto_2mm_map_snrcont.pdf}
      \caption{Top: Maps at 1.25 (left) and 2 (right) mm of MWC349. Bottom: Maps at 1.25 (left) and 2 (right) mm of the Pluto and Charon planetary system The contours in these maps indicate signal-to-noise ratios of 5, 7 and 10.
...
\begin{table*}[t]
  ...
  \end{tabular}
  \tablefoot{
    \tablefoottext{a}{Ratio between the main beam power and the total beam power up to a radius of 250$^{\prime \prime}$}
   \tablefoottext{b}{Average (best) NEFD at zero opacity for the February 2017 observation campaign.}   
   \tablefoottext{c}{Average (best) mapping speed at zero opacity for the February 2017 observation campaign.}   
  }
\end{table*}
