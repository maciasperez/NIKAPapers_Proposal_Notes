...
\begin{document}
%
   \title{The NIKA2 large field-of-view millimetre camera for the 30-m IRAM telescope}
...
In summary, the overall performance of the instrument, mesured preliminarily in laboratory, is in line with the NIKA2 specifications, paving the way to the installation at the telescope. 
...
The NIKA2 integrations on a particular source are split into single observational blocks names "scans". In each scan, the source is moved across the field-of-view, typically by constant-elevation sweeps defined "sub-scans". A peculiar scan, in which the elevation of the antenna is moved between 20 and 65 degrees, is named "skydip". The skydip allows measuring the effective atmosphere temperature, as explained in par \ref{Atmospheric attenuation correction}.
