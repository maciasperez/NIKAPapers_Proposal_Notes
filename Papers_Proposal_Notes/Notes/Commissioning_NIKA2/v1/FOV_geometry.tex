...
5~FWHM at 65 arcsec/s given that the sampling frequency is 23.84Hz,}
...
\samu{Moreover, before projecting the time-ordered data onto maps, we check
  ...
  time-stamping of the impacted data samples are
