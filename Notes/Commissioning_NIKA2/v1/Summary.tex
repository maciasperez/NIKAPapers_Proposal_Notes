...
\item{The mapping speed is defined as the sky area that is covered in
...
\begin{center}    
  \begin{threeparttable}
    \begin{tabular}{|r|c|c|c|c|l|}
      ...
      Pixel size in beam sampling unit\tnote{b}\hspace{1mm} [F$\lambda$] & 0.9 & 0.9  &  &  1.1 & \\
      \hline
...
{\small     
  ...
  \item[(b)] Calculated from real array pixel size [2.8 mm / 2.0 mm] and unvignetted pupil diameter [27m]
...
\begin{table}[h]
  ...
  \begin{threeparttable}
    \begin{tabular}{|r|r|c|c|c|c|}
      ...
      \hline
      Pixel size in beam sampling unit [F$\lambda$]  & Goal    & 0.6  &  0.6 &    &  0.6 \\
                                                     & Specs   & 0.9  &  0.9 &    &  0.9 \\
                                                     & Measure & 1.1  &  1.1 &    &  0.9 \\
      \hline
