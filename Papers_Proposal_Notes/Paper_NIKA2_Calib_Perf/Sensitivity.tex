...
co-addition. \nico{Fitting $\sigma(n)$ vs the corresponding effective
  integration time $\sum_{i=1}^{n}t_i e^{-2\tau_i/\sin\delta_i}$ provides an
  ...
  \citep{hls_combes}, expected to be 74.5\,mJy at 1mm and 15.7\,mJy at 2mm
...
integration using Eq.~\ref{eq:integration_time}, hence derive the NEFD per scan
