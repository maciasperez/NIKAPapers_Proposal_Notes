...
For this purpose, pointing scans are reduced as usual OTF scans using
the data analysis pipeline described in
Sect.~\ref{se:pipeline_overview} with the same parameter as for
...
%traitement FWHM per scans

%comparison FWHM OTF and Pointing
