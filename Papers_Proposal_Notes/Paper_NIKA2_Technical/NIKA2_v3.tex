...
In the present paper we start by describing in some detail the overall instrument design, including cryogenics, focal planes, optics and readout electronics. We will also provide the results of the first commissioning runs at the IRAM 30-meters telescope. The commissioning of the polarisation channel is on-going, and results will be presented in detail in a further paper. We will then, in paragraph \ref{Observations and performance}, present the results from the commissioning runs at the 30-meters telescope. More in-deep details concerning the data analysis pipeline and the commissioning results will be given in coming focussed papers.  
