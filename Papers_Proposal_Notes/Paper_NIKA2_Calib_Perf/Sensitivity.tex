...
We have developed several complementary methods for the NEFD estimation. First,
...
variance weighting \nico{SEE SECTION XXXX}, and it translates to an effective
...
he amplitude of the scaling law provides an estimate of NEFD. To perform this
analysis, during the N2R9 run, we observed \hls, a moderately faint source
...
orientations. Fig.~\ref{fig:nefd_twomethods} shows the noise integration with the
integration time, confirming the expected scaling law. \nico{GIVE NEFD VALUES
  HERE AND/OR IN A TABLE}.\\
...
sources of fluxes below 1\,Jy. Results are presented in
