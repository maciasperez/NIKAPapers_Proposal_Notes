...
1.24  &	1.22  &	0.97  &	Distance between near detectors assuming a $30\,\rm{m}$ diameter aperture [in lambda/D] \\
\hline
\end{tabular}
\end{center}
...
differs by 7 and 2\,arsec from the 2\,mm array center. The sampling is above
