...
Practically, %at the stage of the FOV reconstruction (see
             %Sect.~\ref{se:geometry}),
...
%as their coefficients give the KID gains.
...
%which is further used for the performance assessment.
For cross-check,
...
Figure~\ref{fig:beam_monitoring_otf} shows the FWHM estimates as a %FWHM$_{\rm{geom}}$ as a
