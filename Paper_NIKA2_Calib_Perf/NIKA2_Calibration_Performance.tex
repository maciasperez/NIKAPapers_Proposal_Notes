...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       ...
       {We report an instantaneous field of view (FOV) of 6.5'
         ...
         for the atmospheric attenuation. {\lp The absolute
...
{\lp We have presented NIKA2 performance at the IRAM
  ...
  \baseline\ calibration method to go from
...
\begin{tabular}{rrrcl}
  ...
  \noalign{\smallskip}
    ...
    \hline
    \noalign{\smallskip}
    Absolute calibration uncertainty [\%]      &   5         & 5 & & Sect.~\ref{se:photometry_criteria}, Appendix~\ref{se:ref_flux_uranus_neptune} \\
    Systematic calibration uncertainty\tablefootmark{g}\hspace{3mm}  [\%]      &    0.6        & 0.3 & & Sect.~\ref{se:photometry_criteria}, Appendix~\ref{se:ref_flux_uranus_neptune} \\
  ...
  \tablefoot{ \\
    ...
    \tablefoottext{i}{NEFD extrapolated at zero opacity}
...
\item %\emph{Calibration uncertainties:}
  ...
  ground-based millimeter-wave instrument. 
   \vspace{1mm}
  % noise&sensitivity
