...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       ...
       {We report an instantaneous field of view (FOV) of 6.5'
         ...
         $9 \pm 1\, \rm{mJy}/{beam}\cdot s^{1/2}$ and
         $30 \pm 3\, \rm{mJy}/{beam}\cdot s^{1/2}$. 
         This state-of-the-art performance confers NIKA2 with
         mapping speeds of $1388 \pm 174$ and
         $111 \pm 11 \, \rm{arcmin}^2\cdot (\rm{mJy}/{beam})^{-2}\cdot
         \rm{h}^{-1}$
...
\begin{tabular}{rrrcl}
  ...
  \noalign{\smallskip}
    ...
    \hline
    \noalign{\smallskip}
    NEFD\tablefootmark{h}\hspace{3mm} [$\rm{mJy}/\rm{beam} \cdot \rm{s}^{1/2}$]  & $30 \pm 3$  & $9 \pm 1$ &  & Sect.~\ref{se:nefd_results}\\
    M$_{\rm{s}}$\tablefootmark{i}\hspace{3mm} [arcmin$^2 \cdot
      (\rm{mJy}/\rm{beam})^2 \cdot \rm{h}^{-1}$] & $111 \pm 11$  &  $1388 \pm 174$ &  & \\
    \hline
  \end{tabular}
  \tablefoot{ \\
...
\item %\emph{Sensitivity:}
  ...
  $30 \pm 3\,\rm{mJy}/{beam}\cdot s^{1/2}$ at
  $1\, \rm{mm}$ and $9 \pm 1\,\rm{mJy}/{beam}\cdot s^{1/2}$ at $2\, \rm{mm}$.
...
\item  NIKA2 mapping capabilities are better estimated by evaluating the
  ...
  hour of observation to a noise level of $1\,\rm{mJy}/{beam}$. We found
  mapping speeds at zero atmospheric opacity of $111$ and
  $1388\, \rm{arcmin}^2 \cdot (\rm{mJy}/{beam})^{-2} \cdot \rm{h}^{-1}$ at
