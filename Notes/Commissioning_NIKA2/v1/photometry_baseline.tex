...
and the \afternoon\ beam variation effect is accounted for using the
...
from 0.5 to 0.9 at $1\,\rm{mm}$\samu{: the flux density ratio is constant
within the $1~\sigma$ errors. However, }some scans at atmospheric
transmissions of about 0.7 \new{at $1\,\rm{mm}$} show a mild lack
...
sunrise focus drift respectively.
