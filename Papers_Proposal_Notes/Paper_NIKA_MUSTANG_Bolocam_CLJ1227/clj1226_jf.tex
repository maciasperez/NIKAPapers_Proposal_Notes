...
\title{A Multi-Instrument Non-Parametric Reconstruction of the Electron Pressure Profile in CLJ1226.9}
\input{authorlist}
\input{lablist}
%%%%%%%%%%%%%%%%%%%%%%%%
%\author{
...
\abstract
    {We present the non-parametric pressure profiles of the galaxy cluster CLJ 1226.9+3352 as
      ...
      field of view. The overlap in scales of instrument sensitivity of these three datasets is
      therefore critical in checking
...
outnumbered by the SZ analyses which have fit a parametric (smooth) pressure profile to their data.
...
The observations and data reduction are described in detail in \citet{romero2015a}, and we briefly review them
...
To probe a wider range of scales we complement the MUSTANG data with SZ data from Bolocam \citep{glenn1998}. 
...
diameter, which is well matched to the angular size of $R_{500}$ ($\sim 2$\amin) of CLJ 1227. 
...
last bin in further analysis. However, these outermost bins appear important to include within the
