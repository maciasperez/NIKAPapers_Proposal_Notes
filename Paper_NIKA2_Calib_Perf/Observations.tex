...
scientific-purpose observations with NIKA2. Most of the used observing
modes are based on the usual on-the-fly raster scans, but their
characteristics have been tailored for NIKA2 performance.
...
short raster scans of a bright (above a few Jy) point source at five
position of the secondary mirror (M2) offsets along the optical axis.%, typically
...
The best axial focus is then estimated as the maximum of the flux or the
minimum of the FWHM using parabolic fits of the five measurements.
%Parabolic fits are
...
in the previous paragraph. This focus offset is measured on data using
dedicated sequence of de-focused scans, as discussed in
Sect.~\ref{sec:focus_surfaces}. It is in agreement with expectations
