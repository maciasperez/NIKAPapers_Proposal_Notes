...
cycle. Since the non-linearity of the KID resonance frequency signal with power
...
find an average opacity ratio between the 150~GHz and 260~GHz NIKA2
...
ratio varies significantly for opacities (at 150~GHz) below $0.2$. This effect
...
The first NIKA2 astronomical light was achieved in October 2015. A first technical run followed immediately after. A number of commissioning runs have then been carried out between November, 2015 and April, 2017. The commissioning observations were carried out periodically and without affecting significantly routine observations scheduled at the telescope. Since September, 2016 the instrumental configuration has been fully stable after replacing the 2mm array, the dichroic, and the smooth lenses by anti-reflection ones.
