...
The beam patterning as obtained from this  \bm\ combination is
presented in Fig.~\ref{fig:features}.
...
comparing the beam profiles of a series of 18 \bm\ observations.
...
profiles to the median beam profile, we find a {\lp deviation} below $5\%$ at
...
\noindent {\tt Prof-3G} consists in fitting the beam profile using an empirical function,
which accounts for the main beam and for a significant fraction of the
error beams and side lobes. %, and derive the FWHM from the main beam parameter.
The beam profile $B(r)$ is modeled using a three-Gaussian function,
hence the name of the method, defined as:
\begin{equation}
