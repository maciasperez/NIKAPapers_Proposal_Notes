...
Let us consider a map of resolution $\Delta r$ as obtained from
observations (see Sect.~\ref{se:dataproc}). We also produce a hit map
$N_{\rm{hit}}$, that is the map of the data sample count per pixels. We
primarily evaluate the average observation time per map pixel at the
center of the map
...
the hit map taken in a disk of radius 1\,FWHM to be immune to shot
...
\rm{mm}$ wavelength.   
%Furthermore, the NEFDs are well consistent
