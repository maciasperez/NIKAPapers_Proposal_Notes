...
%    Real_Joint_gNFW_Real_11011111_2500S_500B_100W_pressure.eps
  \caption{The gNFW (parametric) pressure profile as simultaneously fit to the non-parametric pressure profiles.
    The error bars are statistical, from the MCMC fits. The residual significances ($\sigma$) are calculated from the
    assymetric statistical errors (Table~\ref{tbl:nppp_res}) and calibration errors, are plotted in the lower panel.
