...
end-of-life turbo pump, which disappeared once the turbo pump was
replaced. The considered data set allowed us to check the performance
...
the pointing scans, which yields promising results but a mild lack of
...
scans \samu{of sources, whose flux density is above about one Jy/beam,
