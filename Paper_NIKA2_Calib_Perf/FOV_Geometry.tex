...
which allow projecting an individual map per KID, to measure the KID
positions and relative gains, as discussed in
Sect.~\ref{se:fov_geometry}. The measured KID positions are further
...
and we project one map per KID in Nasmyth coordinates. This median filter removes
...
polynomial function of degree one. We call distortion cross-term
between the two spacial coordinates in the polynomial fit.
...
Sect.~\ref{se:fov_geometry}, applied to N2R9 \bm\ scans. 
They are described in Table~\ref{ta:gridmatch}.
...
\begin{table}[!thbp]
  ...
  \begin{tabular}{|r|c|c|c|}
    ...
    \small{Found KID}\tablefootmark{a}       &  736   & 758   & 444  \\
  ...
  \end{tabular}
  \tablefoot{ \\
    \tablefoottext{a}{Initial number of KIDs given in a FOV geometry for the N2R9 campaign.}
...
\begin{center}  
  \begin{tabular}{|l|c|c|c|}
    ...
    \hline
    Designed detectors & 1140  & 1140   & 616  \\
