...
effect mainly impacts the South-West third of the array, which will be referred to
as the "shadow-zone''. \new{This is probably caused by more absorption
of the $1\,\rm{mm}$ polarisation component that illuminates A1 than of
the other component (A3) by the dichroic element.} 
This variation of the flat field translates into a broadening of the
distribution. However, we verified that A1's
flat field dispersions are in line
