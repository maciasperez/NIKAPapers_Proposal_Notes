...
\usepackage[draft,breaklinks, citecolor=blue, linkcolor=Mygreen, urlcolor=Mypink, colorlinks=true, debug, baseurl=' ']{hyperref}
\usepackage{float}
\usepackage{color}
...
\abstract{Magnetic fields, which play a major role in a large number of astrophysical processes from galactic to cosmological scales,
  ...
  %Space observatory satellite observations have unveiled filamentary
...
\begin{figure*}
  \begin{center}
  \includegraphics[%
  width=8.2cm, keepaspectratio]{TOI.pdf}
  \includegraphics[%
  width=7.85cm, keepaspectratio]{spectre_I_fit2.pdf}
\caption{TOI (left) and power spectrum (right) of an observation of Orion OMC-1
  ...
  \begin{center}
    \includegraphics[%
      width=10cm,keepaspectratio]{template_drift.eps}
...
\end{figure}
 \begin{figure*}
   \begin{center}
     \includegraphics[%
       width=6cm,keepaspectratio]{spectre_I_fit_decor.eps}
     \includegraphics[%	
       width=6cm,keepaspectratio]{spectre_Q_decor2.eps}
     \includegraphics[%	
       width=6cm,keepaspectratio]{spectre_U_decor2.eps}
...
%Uncorrected 2 mm
    ...
    \put(0.05,1.22){(b) 2.05 mm raw (top row) and leakage corrected (bottom row) Stokes $I$, $Q$ and $U$ maps.}
      ...
      \put(0,0.6){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_I_map_2mm.eps}}
      \put(0.7,0.6){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_Q_map_2mm.eps}}
     \put(1.4,0.6){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_U_map_2mm.eps}}
  %Corrected 2 mm
      \put(0,0){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_I_map_2mm_corr.eps}}
     \put(0.7,0){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_Q_map_2mm_corr.eps}}
     \put(1.4,0){\includegraphics[width=0.33\linewidth,keepaspectratio]{Uranus_U_map_2mm_corr.eps}}
...
process.
 ...
 \begin{figure} 
  \begin{center}
     \includegraphics[%
      width=1.3\linewidth,keepaspectratio]{pipeline_scheme_v2.eps}
...
%========================================================================================== 
 \begin{figure*}
   \begin{center}
   \includegraphics[%
       width=0.324\linewidth,keepaspectratio]{3C273_I_map_2mm_2.pdf}
     \includegraphics[%
       width=0.33\linewidth,keepaspectratio]{3C273_Q_map_2mm.pdf}
         \includegraphics[%
       width=0.324\linewidth,keepaspectratio]{3C273_U_map_2mm.pdf}
        \includegraphics[%
       width=0.324\linewidth,keepaspectratio]{3C273_I_map_2mm_corr.pdf}  
    \includegraphics[%
       width=0.33\linewidth,keepaspectratio]{3C273_Q_map_2mm_corr.pdf}
     \includegraphics[%
       width=0.324\linewidth,keepaspectratio]{3C273_U_map_2mm_corr.pdf}
...
An additional uncertainty is linked to the HWP zero position determination as discussed in Sect.~\ref{lab_characterization}. 
 \begin{figure*}[h!]
  \begin{center}
   \includegraphics[%
   width=0.48\linewidth,keepaspectratio]{poldeg.pdf}
   \includegraphics[%
   width=0.48\linewidth,keepaspectratio]{polang.pdf}
...
\end{table}
 ...
 \begin{figure*}[h!]
  \begin{center}
   \includegraphics[%
   width=0.45\linewidth,keepaspectratio]{ALMA_PLANCK_sed2_3C286.eps}
   \includegraphics[%
   width=0.45\linewidth,keepaspectratio]{ALMA_PLANCK_sed2_3C273.eps}
 ...
 %OMC-1
  \begin{figure*}
   \begin{center}
   \includegraphics[%
   width=0.324\linewidth,keepaspectratio]{CYGNUSA_I_map.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{CYGNUSA_Q_map.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{CYGNUSA_U_map.pdf}
    \includegraphics[%
   width=0.324\linewidth,keepaspectratio]{CYGNUSA_I_map_2mm.pdf}
    \includegraphics[%
   width=0.324\linewidth,keepaspectratio]{CYGNUSA_Q_map_2mm.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{CYGNUSA_U_map_2mm.pdf}
 ...
 \begin{figure*}
   \begin{center}
   \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_I_map.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_Q_map.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_U_map.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_I_map_2mm.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_Q_map_2mm.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{M87_U_map_2mm.pdf}
   ...
   \begin{center}
     \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{Orion_I_map.pdf}
     \includegraphics[%
   width=0.315\linewidth,keepaspectratio]{Orion_Q_map.pdf}
    \includegraphics[%
   width=0.315\linewidth,keepaspectratio]{Orion_U_map.pdf}
      \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{Orion_I_map_2mm.pdf}
     \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{Orion_Q_map_2mm.pdf}
    \includegraphics[%
   width=0.33\linewidth,keepaspectratio]{Orion_U_map_2mm.pdf}
 \caption{ {\it NIKA} Stokes $I$, $Q$ and $U$ maps of Orion
   ...
   \end{figure*}
    ...
    \begin{center}
     \includegraphics[%
   width=0.8\linewidth,keepaspectratio]{Column_density_Orion.png}
...
\begin{picture}(2,2.5)
 \put(0,2.5){(a)}
   ...
   width=0.4\linewidth,keepaspectratio]{Orion_ipol_1mm.pdf}}
      \put(0.5,2.05){ \includegraphics[%
   width=0.4\linewidth,keepaspectratio]{Orion_ipol_2mm.pdf}}

    \put(0,2.0){(b)}
   
      \put(0.05,1.55){  \includegraphics[width=0.4\linewidth,keepaspectratio]{Orion_poldeg_1mm.pdf}}
	\put(0.5,1.55){\includegraphics[width=0.4\linewidth,keepaspectratio]{Orion_poldeg_2mm.pdf}}
	
     \put(0,1.5){(c) }
   
    \put(0.05,1.05){\includegraphics[%
   width=0.4\linewidth,keepaspectratio]{Orion_angle_1mm.pdf}}
    \put(0.5,1.05){\includegraphics[%
   width=0.4\linewidth,keepaspectratio]{Orion_angle_2mm.pdf}}
	\end{picture}
 \end{center}
\label{Orion_poldeg}
  \end{figure}
