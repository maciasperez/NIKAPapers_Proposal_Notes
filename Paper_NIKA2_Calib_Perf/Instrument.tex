...
($2\, \rm{mm}$) beam is named Array 2 (A2), %from the corresponding observing $2\, \rm{mm}$ waveband,
...
\begin{table}[!htbp]
  \caption[]{Effective frequencies $\nu_{\rm{eff}}$ and bandwidths
    ...
    defined with the precipitable waper vapor (pwv) contents in mm and
    the observing elevation \elev in degrees).}
...
%as round numbers in the middle of the bands
