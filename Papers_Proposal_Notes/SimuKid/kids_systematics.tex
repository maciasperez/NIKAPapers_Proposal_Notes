...
The non-linearity coefficient $\varepsilon'$ does not intervene in the pointing strategy, in fact it is a systematic effect of the instrument and as a consequence will always impact our measures.\\
...
Eq. \ref{eq-NL} is translated in the $C_{l}$ (dans l'espace des Cl ??) by 
