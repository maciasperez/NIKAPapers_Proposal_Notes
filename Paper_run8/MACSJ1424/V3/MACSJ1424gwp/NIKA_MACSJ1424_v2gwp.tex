...
%NIKA2 will be used to map clusters of galaxies at 18 arcsec angular resolution at 150~GHz. 
...
%Using the maps of Fig.~\ref{fig:flux_map} we computed the flux density profiles shown in Fig.~\ref{fig:flux_profiles} by averaging the signal within radial bins around the X-ray center. 
