...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       ...
       {We present {\lp the calibration method} and the performance assessement of NIKA2 after one year of observation.}
       ...
       {We use a large data set acquired between January 2017 and
         ...
         raw data to flux density measurements, which include the reconstruction of the
         field of view (FOV), the measurement of the beam pattern, the
         atmospheric opacity derivation, the flux-density absolute
         scale calibration, the flat fielding and the photometry. We
         ...
         %The dedicated methods that have been developped for
       ...
       {We report a fully covered instantaneous FOV of 6.5'
         ...
         and $6\%$ for these two frequency bands, respectively. This demonstrates
