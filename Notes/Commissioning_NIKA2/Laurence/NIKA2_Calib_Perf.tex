...
A l'issue de ces étapes, les résultats de la calibration sont compilés
...
KID, un rayon cosmique n'affecte qu'un seul échantillon de données,
...
pointages, les TOI calibrées et dé-bruitées de tous les KID valides
...
\begin{figure}[!thbp]
\begin{center}
\includegraphics[trim=3cm 14cm 6cm 4cm, clip=true, width=0.45\linewidth]{Figures/NIKA2/A1_fwhm_color_count.pdf}
%\includegraphics[trim=2cm 14cm 5cm 4cm, clip=true,width=0.45\linewidth]{Figures/A1_positions.pdf}
\includegraphics[trim=3cm 14cm 6cm 4cm, clip=true, width=0.45\linewidth]{Figures/NIKA2/A3_fwhm_color_count.pdf}
%\includegraphics[trim=2cm 14cm 5cm 4cm, clip=true,width=0.45\linewidth]{Figures/A3_positions.pdf}
\includegraphics[trim=3cm 14cm 6cm 4cm, clip=true, width=0.45\linewidth]{Figures/NIKA2/A2_fwhm_color_count.pdf}
%\includegraphics[trim=2cm 14cm 5cm 4cm, clip=true,width=0.45\linewidth]{Figures/A2_positions.pdf}
\caption[La sélection des KID]{Géométrie moyenne des matrices A1, A3
  et A2. Chacune des figures montre la position des détecteurs
  dans le plan focal, en secondes d'arc, ainsi que leur lobe modélisé par une
...
\caption[Noticeable features of NIKA2 beam pattern.]{Cartographie du
  ...
  couvrent une zone du ciel de $10'$ de coté. En plus du lobe principal
  ...
  supportant le miroir secondaire à 2\,mm) qui sont commentées dans le
  texte.}
\label{fig:features}
\end{center}
\end{figure}
...
\begin{figure}[!thbp]
  \centering
   \includegraphics[clip, width=0.65\linewidth]{Figures/NIKA2/plot_profiles_dB_1mm.pdf}
   \includegraphics[clip, width=0.65\linewidth]{Figures/NIKA2/plot_profiles_dB_a2.pdf}
   \caption[Stability of the beam profile]{Profiles radiaux des lobes
     à 1\,mm (en haut) et 2\,mm (en bas) tracés en décibels en
...
\begin{figure}[!thbp]
\begin{center}
  \includegraphics[clip, width=0.45\textwidth]{Figures/NIKA2/plot_FWHM_vs_atmtrans_mb_radius_binning2_1mm.pdf}
  \includegraphics[clip, width=0.45\textwidth]{Figures/NIKA2/plot_FWHM_vs_atmtrans_mb_radius_binning2_a2.pdf}
...
En utilisant ce modèle, nous estimons une efficacité du lobe principal de
...
\begin{figure}[!thbp]
  \begin{center}
   ...
   \caption[]{Tests cohérence et de stabilité des estimations de
     ...
     filtrage, $\tau_{225}$. La corrélation $\tau_{\rm{skydip}}$ -
...
signifiance de la mesure des lobes secondaires. En revanche, nous
...
significativement élargie, et cet élargissement est dû aux gains des
...
une éventuelle mise en œuvre d'observations dédiées, nous avons
...
\begin{figure}[!thbp]
  \begin{center}
    ...
    \caption[Baseline calibration rms error estimate]{Incertitudes RMS de la calibration \emph{baseline}. La figure présente le rapport entre les densités de flux mesurées et la densité de flux médiane pour un ensemble de sources brillantes, en fonction de la transmission atmosphérique, pour la combinaison des matrices A1$\&$A3 (panneau de gauche) et pour la matrice A2 (panneau de droite). Le code de couleur indique l'heure d'observation UT du scan. Les lignes pointillées, de part et d'autre de la ligne continue correspondant à un rapport unité, indiquent l'erreur RMS pour les lignes les plus internes et l'intervalle à $95\%$ de niveau de confiance pour les plus externes. On note que les points dont le rapport de flux est le plus faible correspondent à des observations effectuées pendant la journée entre 8:00 et 15:00 UT (en jaune et rouge), tandis que les observations de nuit, entre 22:00 et 7:00 UT correspondent à des points de mesures en accord avec la médiane dans les barres d'erreur RMS avec peu de points aberrants.}
