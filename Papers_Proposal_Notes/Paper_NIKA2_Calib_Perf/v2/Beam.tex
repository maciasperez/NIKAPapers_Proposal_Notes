...
$\mathcal{A}_{\nu}^{(4)}$ are the amplitudes of the third and fourth
Gaussian error beams $G_{\nu}^{(3)}$ and $G_{\nu}^{(4)}$,
respectively, which are measured with EMIR and extrapolated for the
array $\nu$ following the presciption given in \citet{Kramer2013}, and
$\Omega_{\rm{FSL}} (\nu)$ is the contribution of the far side lobes to
the total beam solid angle of the array $\nu$, as derived from
$F_{\rm{eff}}$ measurements.}
...
%
\begin{table}[!h]
\caption{Estimates of the contribution to the beam solid angle. All solid angles are given in arcsec$^{2}$. }
