...
% 5 {} token are mandatory
   ...
   % {} leave it empty if necessary  
       {The New IRAM KID Array, NIKA2, is a dual-band millimetric
         ...
         telescope at Pico Veleta (Spain).
         ...
         NIKA2, which is open to the community since October 2017,
         will provide key observations for a vast variety of
         astrophysic and cosmology purposes.}
         %, including planet
       ...
       {We find an average fraction of usable detectors during a
         ...
         statistical relative calibration uncertainties are of about 6
