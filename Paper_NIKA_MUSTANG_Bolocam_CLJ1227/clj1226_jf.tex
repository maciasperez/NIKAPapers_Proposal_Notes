...
paper maximizes the marginalized posterior distribution, where the principle difference is our employment of analytic integrals.
...
is seen \citep{romero2017}. At 500 $\mu$m, \emph{Herschel}-SPIRE has a point source sensitivity of $\sim 8$ mJy, \textbf{but no point
...
\end{equation}
\textbf{This formulation assumes that the data is well described by a Gaussian distribution; however Table~\ref{tbl:nppp_res}
