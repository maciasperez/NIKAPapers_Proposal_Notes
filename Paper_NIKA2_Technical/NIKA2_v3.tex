...
\begin{figure*}[h]
   \centering
%    \includegraphics[width=0.9\linewidth]{Fig4_spectra.png}
    \includegraphics[trim=0cm 12cm 4cm 4cm, clip=true,width=0.33\linewidth]{A1_fwhm_color_count.pdf}
   \includegraphics[trim=0cm 12cm 4cm 4cm, clip=true,width=0.33\linewidth]{A3_fwhm_color_count.pdf}
   \includegraphics[trim=0cm 12cm 4cm 4cm, clip=true,width=0.33\linewidth]{A2_fwhm_color_count.pdf}
       
      \caption{From left to right detector position for arrays A1, A3, and A2.}
...
\begin{figure*}[h]
  ...
  \caption{From left to right, main beam FWHM histogram for arrays A1, A3, and A2.}
  \label{fig:focalplane_histo}
\end{figure*}

Figure~\ref{fig:focalplane_histo} shows the distribution of the main beam FWHM of the array A1, A3 and A2 detectors across the NIKA2 FOV. 
