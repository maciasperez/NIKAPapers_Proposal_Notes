...
\label{sec:nikaobs}
We use in this paper NIKA camera observations of the cluster CLJ 1227, which were obtained at the IRAM 30 m telescope (Pico Veleta) in February 2014 and presented in \citet{adam2015}. NIKA \citep{monfardini2010,monfardini2014} was a dual band camera working at 150 and 260 GHz, and made of Kinetic Inductance Detectors (KIDs) operated at 100 mK by using a closed cycle $^3$He-$^4$He dilution fridge. 
Furthermore, with a circular field-of-view (FOV) of 1.9$^{\prime}$ (1.8$^{\prime}$) and a resolution of 18.2$^{\prime \prime}$ (12.0$^{\prime \prime}$) at 150 (160) GHz NIKA was particularly well adapted to map the thermal Sunyaev-Zeldovich effect in such a high redshift cluster. A detailed description of the performance of the camera can be found in \citet{catalano2014,adam2014}.

CLJ 1227 was mapped using on-the-fly raster scans made of either constant azymuth or constant elevation subscans.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Analytic Integrals of Elliptically Symmetric Power Laws}
