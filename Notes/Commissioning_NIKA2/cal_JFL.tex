...
\noindent {\bf FM: it would help the reader to have all these values in a table}\\ 
...
\begin{center}
  ...
  at high transmission ($>~0.8$), is hinted. {\bf FM: the scale of the y axis should be much shorter}}
...
4 consecutive otf scans  
(16 min) providing comparable integration times. The aperture radius was as large $150''$ to reach saturation level
...
\begin{center}
  ...
  \caption{Stability of the flux density scale with the primary calibrators Uranus (red) and Neptune (blue) :
    ...
    Observations are beammaps (22 min) or sequence of 4 consecutive 4 minute long otfs (16 min) that are
...
\begin{center}
  ...
  \caption{Flux density ratios versus elevation, opacity, and attenuation ($exp(-\tau/sin(elev)$) for Uranus and Neptune.
    No correlation is apparent with attenuation. {\bf FM: the scale of the y axis should be much shorter}}
...
\includegraphics[clip, angle=0, scale=0.55]{Figures/Corr_r9.png}
  ...
  \caption{Correlation plots for the flux density ratios between  the three arrays
    ...
    Correlation coefficients $\rho$ are given. {\bf FM: the scale of the y and x axis should be much shorter}}
\label{fig:U_N_corr}
\end{center}                                                                                                             
\end{figure}
