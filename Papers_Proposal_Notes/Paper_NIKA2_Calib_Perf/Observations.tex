...
short raster scans of a bright (above a few Jy) point source at five position of the
secondary mirror (M2) offsets along the optical axis.%, typically
...
namely 4.8~arcsec. We observe the source with a raster scan in (az,el)
...
subtraction in the scanning direction. During subscans, the telescope moves at
