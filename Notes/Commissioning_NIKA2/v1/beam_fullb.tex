...
\begin{itemize}
\item[(1)] \new{the main beam and the underlying first error
  beam, which is due to the large scale deformations of the primary
  mirror, and the first side lobes. \new{The latter include 
  ...
  %simulations;
\item[(2)] \new{the diffraction ring by panel buckling of the primary mirror, as shown with
  a red circle in the A1 panel};
\item[(3)] \new{the side lobes shown with green
...
\new{We further quantify the respective level of the axi-symmetrical
