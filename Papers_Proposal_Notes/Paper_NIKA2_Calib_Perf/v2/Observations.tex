...
%of several linear scanning legs, combined to one
%map.
...
small enough
%to meet Nyquist sampling of the 1\,mm beam for each KID.
...
65\,arcsec/s.
%This value results of a tradeoff between the need to scan as
...
%constraint).
%The need to have Nyquist sampling of 11'' beams
...
subscans last 12\,s and the entire scan lasts about 25\,min.%, which is short enough
