...
applied to the skydip opacity to ensure the flux density stablity
...
We have identified several areas of improvement that will make NIKA2
...
\begin{center}    
  \begin{threeparttable}
    \begin{tabular}{|r|c|c|c|c|l|}
      ...
      \hline
      $\alpha$ noise integration in time\tnote{c}\hspace{1mm}  & 0.5  & 0.5  &  0.5 & 0.5 & Sect.~\ref{se:nefd_m1} \\
      \hline
...
%%%%  \item[(a)] Equivalent FOV covered by the valid detectors
  \item[(a)] Calculated from real array pixel size [2.75 mm / 2.0 mm] and unvignetted pupil diameter [27m]
