...
\hline
     &  &  A1 & A3  & A2 \\
\hline
Main beam flat field  & all the FOV           &   &   &  \\
                      & shadow-zone excluded  &   &   &  \\
\hline
Forward beam flat field  & all the FOV           &   &   &    \\
                         & shadow zone excluded  &   &   &  \\
\hline
\end{tabular}
\caption{Flat field dispersions over all the FOV and after masking out the shadow-zone}
\end{center}
