...
temperature-induced beam variation effect. An explanation for the
...
The calibration uncertainties for the five methds evaluated using
flux-selected source scans are gathered in the row labelled 'Rms'
of Table~\ref{tab:Calibration_results_all}.

Compared to the baseline method, the 'taumeter' method leads to 
...
Moreover, results based on the {\tt photocorr demo} method show that calibration
