...
\begin{figure}[ht]
\begin{center}
\hspace*{-1cm}\includegraphics[angle=0, scale = 0.3]{Figures/FOV_A1.png}
\hspace*{-1cm}\includegraphics[angle=0, scale = 0.3]{Figures/FOV_A2.png}
\hspace*{-1cm}\includegraphics[angle=0, scale = 0.3]{Figures/FOV_A3.png}
