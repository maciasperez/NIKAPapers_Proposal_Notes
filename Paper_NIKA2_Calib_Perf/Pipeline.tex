...
detection. In this section, we summarize the main steps of the data
...
using the zenith opacity $\tau$, which is estimated for a given scan
as discussed in Sect.~\ref{se:opacity}, and the instantaneous
observing elevation $\elev_t$, as obtained using the pointing reconstruction.\\     
...
cuts rely on zenith opacity estimates $\tau_i$ in NIKA2 bands, as
