...
observing condition. However, we note some difference between the
...
practical method, \aka\ 'photocorr pointing'.   
...
without any scan selection based on the observation date. However,
...
these calibration methods. By contast, the baseline method allies good
